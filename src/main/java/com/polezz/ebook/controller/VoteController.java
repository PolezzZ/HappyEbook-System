 ...
 *
 * Create Time: 2018年5月17日 上午11:47:45
 */
 ...
 * @version 1.0.0, 2018年5月17日 上午11:47:45
 */
@Controller
...
public class VoteController {
    ...
    public ResponseEntity<Response> createVote(Long ebookId) {

        try {
            ebookService.createVote(ebookId);
    ...
    public ResponseEntity<Response> delete(@PathVariable("id") Long id,
        ...
        try {
            ebookService.removeVote(ebookId, id);
